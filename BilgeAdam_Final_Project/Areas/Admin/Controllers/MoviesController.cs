...
namespace BilgeAdam_Final_Project.Areas.Admin.Controllers
{
    ...
    public class MoviesController : Controller
    {
        ...
        {
            // Kategori listesi ve film listesi ModelState.IsValid olmadığı zaman boş dönmesin diye ViewBag'ler buraya da yazılır  
            ViewBag.Categories = new SelectList
                (
                    await _categoriesRepo.GetAllAsync(), "Id", "Name"
                );
        ...
        public async Task<IActionResult> UpdateMovie(UpdateMovieDTO model)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                if (model.UploadImage != null)
                {
                    ...
                    {
                        string oldPath = Path.Combine(_webHostEnvironment.WebRootPath, "images/movies");
